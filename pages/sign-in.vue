  ...
  <b-container class="mt-5">
    ...
    <b-row>
      <b-col md="10" lg="8" class="mx-auto">
        <b-form>
          ...
          <b-button type="button" variant="primary" class="float-right" @click="register">Je me connecte</b-button>
        </b-form>
      </b-col>
    </b-row>
    <div style="overflow: hidden;" class="fixed-bottom">
      <svg
        ...
        style="fill: #006ccf; width: 265%; height: 400px; transform: rotate(180deg); background-position: bottom center;"
      >
        <path
